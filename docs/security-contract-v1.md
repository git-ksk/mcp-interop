...
[English](security-contract-v1.md) | [日本語](security-contract-v1.ja.md)

This document defines the minimum security and operational guarantees for the stable v1.x contract. A future release may reject more unsafe input or tighten isolation without that being considered a compatibility regression.
