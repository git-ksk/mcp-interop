...
[English](security-contract-v1-candidate.md) | **日本語**

この文書は将来stable contractで維持するsecurity/operational guarantee候補を定義します。これらはminimum guaranteeであり、将来releaseがunsafe inputをより厳しくrejectしたりisolationを強化することはcompatibility regressionとは扱いません。
