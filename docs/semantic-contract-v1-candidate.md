# Interoperability semantics v1 candidate

[English](semantic-contract-v1-candidate.md) | [日本語](semantic-contract-v1-candidate.ja.md)

This document records the v1-candidate meanings for adapter identity, maturity, core PASS, optional capabilities, and protocol-era normalization.
