...
v1.0.0のrelease surfaceは準備済みですが、まだtagしていません。明示的なrelease操作まではv0.10.0が現在の公開版です。Cursor / Antigravity OAuth経路はv0.4.0で導入され、adapterのstable non-OAuth core scope外のままです。
