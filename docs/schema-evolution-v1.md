...
[English](schema-evolution-v1.md) | [日本語](schema-evolution-v1.ja.md)

This document defines the stable v1 evolution policy for portable evidence, suite state, baselines, and derived machine reports. It complements the [Public contract v1](public-contract-v1.md).
