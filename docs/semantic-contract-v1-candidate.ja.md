...
[English](semantic-contract-v1-candidate.md) | **日本語**

この文書はadapter identity、maturity、core PASS、optional capability、protocol-era normalizationのv1-candidate meaningを定義します。
