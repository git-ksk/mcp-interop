...
[English](public-contract-v1.md) | [日本語](public-contract-v1.ja.md)

This document defines the public meanings for the stable `v1.x` compatibility promise. It does not retroactively make every internal implementation detail public API.
...
Portable schema evolution, migration, baseline authenticity, and deprecation rules are defined in [Schema evolution v1](schema-evolution-v1.md).
...
Interoperability identity, maturity, core PASS, capability, and protocol-era meanings are defined in [Interoperability semantics v1](semantic-contract-v1.md).

Security, privacy, credential isolation, cleanup, privileged CI, and tagged-release guarantees are defined in [Security, privacy, cleanup, and release contract v1](security-contract-v1.md).
