...
[English](schema-evolution-v1.md) | **日本語**

この文書はportable evidence、suite state、baseline、derived machine reportのstable v1 evolution policyを定義します。[Public contract v1](public-contract-v1.ja.md)を補完します。
